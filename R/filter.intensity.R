...
#' these signals.
#'
#' @usage \code{filter.intensity(x, centered = TRUE, centred = centered, scaled = TRUE, 
#'                               highpass = NULL, highpass.remove = TRUE, lowpass  = NULL, lowpass.remove  = TRUE)}
...
filter.intensity <- function(x, centered = TRUE, centred = centered, scaled = TRUE, 
